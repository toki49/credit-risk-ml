...
FIGURE_PATH = Path("figures/model_comparison.png")
...
FOLDS = [
    {"label": "Fold 1", "train_years": [2015, 2016, 2017], "val_year": 2018, "model_path": MODELS_DIR / "rf_fold1.pkl"},
    {"label": "Fold 2", "train_years": [2015, 2016, 2017, 2018], "val_year": 2019, "model_path": MODELS_DIR / "rf_fold2.pkl"},
]
...
def main() -> None:
    ...
    print(f"Saved models to: {(MODELS_DIR / 'rf_fold1.pkl').resolve()} and {(MODELS_DIR / 'rf_fold2.pkl').resolve()}")
